...
const INTENT_RULES = [
    ...
    },
    {
        ...
        keywords: [
            ...
            'السلام عليكم', 'وعليكم السلام', 'اهلا'
        ]
    },
    {
    ...
    },
    {
        ...
        keywords: [
            ...
            'منتجاتكم', 'عندكم', 'شنو', 'واش', 'المنتجات', 'بيعو'
        ]
    },
    {
        intent: 'discount_inquiry',
        keywords: [
            'تخفيض', 'عرض', 'خصم', 'برومو', 'promo', 'تخفيضات',
            'عروض', 'تسوق'
        ]
    },
    {
        ...
        keywords: [
            'ساعات', 'وقت العمل', 'متى تفتحوا', 'متى تقفلوا',
            'اوراري', '工作时间'
        ]
    },
    {
        intent: 'store_info',
        keywords: [
            'وين', 'موقعكم', 'عنوان', 'adresse', 'مقركم',
            'المتجر', 'المحل', 'أين'
        ]
    },
    {
    ...
    },
    {
        intent: 'how_to_order',
        keywords: [
            'كيفاش', 'كيفية', 'الطلب', 'نطلب', 'الشراء', 'طريقة',
            'تحميل', 'طلب منتوج', 'واش نكتب'
        ]
    }
];
